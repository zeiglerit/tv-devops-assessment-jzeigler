// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/networkmanager_link
...
export class DataAwsNetworkmanagerLink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/networkmanager_link#import import section} in the documentation of this resource for the id to use
