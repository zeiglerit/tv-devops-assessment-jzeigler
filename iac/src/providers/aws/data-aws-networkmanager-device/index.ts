// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/networkmanager_device
...
export class DataAwsNetworkmanagerDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/networkmanager_device#import import section} in the documentation of this resource for the id to use
