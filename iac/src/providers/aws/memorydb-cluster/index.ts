// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/memorydb_cluster
...
export class MemorydbCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MemorydbCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/memorydb_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      multi_region_cluster_name: cdktf.stringToTerraform(this._multiRegionClusterName),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      multi_region_cluster_name: {
        value: cdktf.stringToHclTerraform(this._multiRegionClusterName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
