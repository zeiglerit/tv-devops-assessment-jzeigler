// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/organizations_policy_attachment
...
export class OrganizationsPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationsPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/organizations_policy_attachment#import import section} in the documentation of this resource for the id to use
