// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/rds_reserved_instance_offering
...
export class DataAwsRdsReservedInstanceOffering extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRdsReservedInstanceOffering that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/rds_reserved_instance_offering#import import section} in the documentation of this resource for the id to use
