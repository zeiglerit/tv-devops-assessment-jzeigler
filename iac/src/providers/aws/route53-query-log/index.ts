// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/route53_query_log
...
export class Route53QueryLog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53QueryLog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/route53_query_log#import import section} in the documentation of this resource for the id to use
