// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/medialive_input_security_group
...
export class MedialiveInputSecurityGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MedialiveInputSecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/medialive_input_security_group#import import section} in the documentation of this resource for the id to use
