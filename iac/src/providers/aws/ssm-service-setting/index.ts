// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ssm_service_setting
...
export class SsmServiceSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmServiceSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ssm_service_setting#import import section} in the documentation of this resource for the id to use
