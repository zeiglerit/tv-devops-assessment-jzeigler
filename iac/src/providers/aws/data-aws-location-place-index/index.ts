// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/location_place_index
...
export class DataAwsLocationPlaceIndex extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLocationPlaceIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/location_place_index#import import section} in the documentation of this resource for the id to use
