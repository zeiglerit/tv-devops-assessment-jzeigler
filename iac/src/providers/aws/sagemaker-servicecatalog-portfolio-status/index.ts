// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/sagemaker_servicecatalog_portfolio_status
...
export class SagemakerServicecatalogPortfolioStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerServicecatalogPortfolioStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/sagemaker_servicecatalog_portfolio_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/sagemaker_servicecatalog_portfolio_status aws_sagemaker_servicecatalog_portfolio_status} Resource
  *
  * @param scope The scope in which to define this construct
