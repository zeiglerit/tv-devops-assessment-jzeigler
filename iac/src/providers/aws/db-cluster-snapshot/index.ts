// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/db_cluster_snapshot
...
export class DbClusterSnapshot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbClusterSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/db_cluster_snapshot#import import section} in the documentation of this resource for the id to use
