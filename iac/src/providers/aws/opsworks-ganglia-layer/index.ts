// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_ganglia_layer
...
export class OpsworksGangliaLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksGangliaLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_ganglia_layer#import import section} in the documentation of this resource for the id to use
