// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/sns_topic
...
export class SnsTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnsTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/sns_topic#import import section} in the documentation of this resource for the id to use
