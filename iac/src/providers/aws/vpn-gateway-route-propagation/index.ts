// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/vpn_gateway_route_propagation
...
export class VpnGatewayRoutePropagation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnGatewayRoutePropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/vpn_gateway_route_propagation#import import section} in the documentation of this resource for the id to use
