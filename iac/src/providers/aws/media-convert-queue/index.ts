// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/media_convert_queue
...
export class MediaConvertQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaConvertQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/media_convert_queue#import import section} in the documentation of this resource for the id to use
