// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/egress_only_internet_gateway
...
export class EgressOnlyInternetGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EgressOnlyInternetGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/egress_only_internet_gateway#import import section} in the documentation of this resource for the id to use
