// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/iam_service_specific_credential
...
export class IamServiceSpecificCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamServiceSpecificCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/iam_service_specific_credential#import import section} in the documentation of this resource for the id to use
