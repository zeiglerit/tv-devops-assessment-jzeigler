// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/appmesh_virtual_service
...
export class DataAwsAppmeshVirtualService extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppmeshVirtualService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/appmesh_virtual_service#import import section} in the documentation of this resource for the id to use
