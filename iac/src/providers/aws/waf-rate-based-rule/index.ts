// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/waf_rate_based_rule
...
export class WafRateBasedRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafRateBasedRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/waf_rate_based_rule#import import section} in the documentation of this resource for the id to use
