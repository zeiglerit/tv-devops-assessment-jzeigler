// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/glue_catalog_table
...
export function glueCatalogTableOpenTableFormatInputIcebergInputToTerraform(struct?: GlueCatalogTableOpenTableFormatInputIcebergInputOutputReference | GlueCatalogTableOpenTableFormatInputIcebergInput): any {
  ...
  return {
    metadata_operation: cdktf.stringToTerraform(struct!.metadataOperation),
...
export class GlueCatalogTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueCatalogTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/glue_catalog_table#import import section} in the documentation of this resource for the id to use
