// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/neptune_cluster_instance
...
export class NeptuneClusterInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NeptuneClusterInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/neptune_cluster_instance#import import section} in the documentation of this resource for the id to use
