// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ebs_default_kms_key
...
export class EbsDefaultKmsKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsDefaultKmsKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ebs_default_kms_key#import import section} in the documentation of this resource for the id to use
