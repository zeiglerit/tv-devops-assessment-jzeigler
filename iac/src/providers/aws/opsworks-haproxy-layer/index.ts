// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_haproxy_layer
...
export class OpsworksHaproxyLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksHaproxyLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_haproxy_layer#import import section} in the documentation of this resource for the id to use
