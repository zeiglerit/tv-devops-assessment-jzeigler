// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/rds_cluster_activity_stream
...
export class RdsClusterActivityStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsClusterActivityStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/rds_cluster_activity_stream#import import section} in the documentation of this resource for the id to use
