// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ses_receipt_rule_set
...
export class SesReceiptRuleSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesReceiptRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ses_receipt_rule_set#import import section} in the documentation of this resource for the id to use
