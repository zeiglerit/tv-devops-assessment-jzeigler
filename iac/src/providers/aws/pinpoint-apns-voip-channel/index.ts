// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/pinpoint_apns_voip_channel
...
export class PinpointApnsVoipChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointApnsVoipChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/pinpoint_apns_voip_channel#import import section} in the documentation of this resource for the id to use
