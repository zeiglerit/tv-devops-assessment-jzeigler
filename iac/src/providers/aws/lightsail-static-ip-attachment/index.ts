// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/lightsail_static_ip_attachment
...
export class LightsailStaticIpAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailStaticIpAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/lightsail_static_ip_attachment#import import section} in the documentation of this resource for the id to use
