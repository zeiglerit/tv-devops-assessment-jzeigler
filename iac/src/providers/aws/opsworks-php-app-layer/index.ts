// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_php_app_layer
...
export class OpsworksPhpAppLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksPhpAppLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/opsworks_php_app_layer#import import section} in the documentation of this resource for the id to use
