// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/lb_hosted_zone_id
...
export class DataAwsLbHostedZoneId extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLbHostedZoneId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/lb_hosted_zone_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/lb_hosted_zone_id aws_lb_hosted_zone_id} Data Source
  *
  * @param scope The scope in which to define this construct
