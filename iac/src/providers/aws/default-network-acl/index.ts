// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/default_network_acl
...
export class DefaultNetworkAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultNetworkAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/default_network_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/default_network_acl aws_default_network_acl} Resource
  *
  * @param scope The scope in which to define this construct
