// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ec2_instance_state
...
export class Ec2InstanceState extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2InstanceState that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ec2_instance_state#import import section} in the documentation of this resource for the id to use
