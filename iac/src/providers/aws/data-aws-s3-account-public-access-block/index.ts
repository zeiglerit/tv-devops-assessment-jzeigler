// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/s3_account_public_access_block
...
export class DataAwsS3AccountPublicAccessBlock extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsS3AccountPublicAccessBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/s3_account_public_access_block#import import section} in the documentation of this resource for the id to use
