// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/backup_vault_policy
...
export class BackupVaultPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupVaultPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/backup_vault_policy#import import section} in the documentation of this resource for the id to use
