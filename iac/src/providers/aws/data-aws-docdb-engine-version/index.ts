// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/docdb_engine_version
...
export class DataAwsDocdbEngineVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDocdbEngineVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/docdb_engine_version#import import section} in the documentation of this resource for the id to use
