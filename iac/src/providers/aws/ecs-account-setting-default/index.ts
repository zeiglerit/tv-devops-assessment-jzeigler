// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ecs_account_setting_default
...
export class EcsAccountSettingDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsAccountSettingDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/ecs_account_setting_default#import import section} in the documentation of this resource for the id to use
