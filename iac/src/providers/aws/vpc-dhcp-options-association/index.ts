// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/vpc_dhcp_options_association
...
export class VpcDhcpOptionsAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcDhcpOptionsAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/vpc_dhcp_options_association#import import section} in the documentation of this resource for the id to use
