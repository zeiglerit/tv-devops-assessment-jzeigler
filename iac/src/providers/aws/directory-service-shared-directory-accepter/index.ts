// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/directory_service_shared_directory_accepter
...
export class DirectoryServiceSharedDirectoryAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceSharedDirectoryAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/directory_service_shared_directory_accepter#import import section} in the documentation of this resource for the id to use
