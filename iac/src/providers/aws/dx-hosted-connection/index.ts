// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/dx_hosted_connection
...
export class DxHostedConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxHostedConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/dx_hosted_connection#import import section} in the documentation of this resource for the id to use
