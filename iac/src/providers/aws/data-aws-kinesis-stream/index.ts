// https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/kinesis_stream
...
export class DataAwsKinesisStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKinesisStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/kinesis_stream#import import section} in the documentation of this resource for the id to use
